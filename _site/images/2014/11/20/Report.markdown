<center><h1>AI HW1: 二值图像降噪</h1></center>
...
图1、实验原图|图2、二值化后的图像
-----------|----------------
![](AI.png)|![](binaryzation.png)

<br />

图3、加噪后的图像|图4、一级爬山法的效果图
-----|-----
![](addNoice.png)|![](denoice(1).png)
